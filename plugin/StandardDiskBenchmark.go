...
var StandardDiskBenchmark *tStandardDiskBenchmark = newStandardDiskBenchmark()

type tStandardDiskBenchmark struct {
	*benchmark.Benchmark
	nameText        string
...
func newStandardDiskBenchmark() *tStandardDiskBenchmark {
	c := tStandardDiskBenchmark{
		nameText:        "Disk",
...
func (c *tStandardDiskBenchmark) SetUp() error {
...
func (c *tStandardDiskBenchmark) Execute() error {
	if c.fd == nil {
		return nil
	}
...
func (c *tStandardDiskBenchmark) TearDown() error {
