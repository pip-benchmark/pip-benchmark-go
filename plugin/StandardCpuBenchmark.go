...
var StandardCpuBenchmark *tStandardCpuBenchmark = newStandardCpuBenchmark()

type tStandardCpuBenchmark struct {
	*benchmark.Benchmark
	numberOfAttempts int
}

func newStandardCpuBenchmark() *tStandardCpuBenchmark {
	c := tStandardCpuBenchmark{
...
func (c *tStandardCpuBenchmark) Execute() error {
